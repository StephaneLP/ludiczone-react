    ...
    return (
        <section className="container-fluid search">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-6 search-box" onClick={() => retourner('1')}>
                    ...
                    <div className="col-12 col-md-6 search-box" onClick={() => retourner('2')}>
                    ...
                    <div className="col-12 col-md-6 search-box" onClick={() => retourner('3')}>
                    ...
                    <div className="col-12 col-md-6 search-box"  onClick={() => retourner('4')}>
